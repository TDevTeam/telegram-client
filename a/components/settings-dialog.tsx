        ...
        <Tabs defaultValue="general">
          ...
          <TabsContent value="notifications" className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch checked={notificationPreview} onCheckedChange={setNotificationPreview} />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch checked={notificationBadge} onCheckedChange={setNotificationBadge} />
            </div>
          ...
          <TabsContent value="privacy" className="space-y-4">
            <div className="space-y-3">
              ...
              <RadioGroup value={lastSeenPrivacy} onValueChange={setLastSeenPrivacy}>
            ...
            <div className="space-y-3">
              ...
              <RadioGroup value={profilePhotoPrivacy} onValueChange={setProfilePhotoPrivacy}>
                <div className="flex items-center space-x-2">
            ...
            <div className="space-y-3">
              <Label>Calls</Label>
              <RadioGroup value={callsPrivacy} onValueChange={setCallsPrivacy}>
                <div className="flex items-center space-x-2">
            ...
            <div className="space-y-3">
              ...
              <RadioGroup value={forwardedPrivacy} onValueChange={setForwardedPrivacy}>
                <div className="flex items-center space-x-2">
